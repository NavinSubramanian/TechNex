    ...
    >
      {!hasStarted ? (
        <div style={{ margin: "auto", display:'flex', flexDirection:'column',textAlign:'center',rowGap:'10px',alignItems:'center',justifyContent:'center' }}>
          <img style={{height:'450px',width:'450px',objectFit:'cover',mixBlendMode:'multiply'}} src="https://static.vecteezy.com/system/resources/thumbnails/003/586/628/small/online-testing-background-illustration-with-checklist-taking-exam-choosing-answer-form-e-learning-and-education-concept-vector.jpg" />
          ...
          <p>Thank You - CDC</p>
          <button onClick={handleStartTest} style={{padding:'7px 10px', backgroundColor:'black', color:'white', cursor:'pointer'}}>Start Test</button>
        </div>
      ) : isFullScreen ? (
        <>
